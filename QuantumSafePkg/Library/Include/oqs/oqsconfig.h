...
#ifndef __OQS_CONFIG_H__
#define __OQS_CONFIG_H__

#define OQS_VERSION_TEXT "0.5.0-rc1"
#define OQS_COMPILE_BUILD_TARGET "UEFI-generic"
#define OQS_COMPILE_CFLAGS " -fvisibility=hidden -Werror -Wall -Wextra -Wpedantic -Wimplicit -Wunused -Wcomment -Wchar-subscripts -Wuninitialized -Wstrict-prototypes -Wshadow -Wformat-security -Wwrite-strings -O3 -fomit-frame-pointer -march=native"
...
// link warning: secure_decode_portable.obj : warning LNK4006: secure_l32_mask already defined in utilities.obj; second definition ignored
// fail - link error: OqsKemBikeLib.lib(kem_bike.obj) : error LNK2001: unresolved external symbol OQS_KEM_bike1_l3_cpa_encaps
...
// pass - after enlarge stack to 0x2000000
